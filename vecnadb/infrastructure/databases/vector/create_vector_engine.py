...
from vecnadb.infrastructure.databases.graph.config import get_graph_context_config
...
def create_vector_engine(
    ...
    if vector_db_provider.lower() == "pgvector":
        from vecnadb.infrastructure.databases.relational import get_relational_config
