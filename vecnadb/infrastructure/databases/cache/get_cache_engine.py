...
from vecnadb.infrastructure.databases.cache.cache_db_interface import CacheDBInterface
from vecnadb.infrastructure.databases.cache.fscache.FsCacheAdapter import FSCacheAdapter
...
def create_cache_engine(
    ...
    """
    if config.caching:
        from vecnadb.infrastructure.databases.cache.redis.RedisAdapter import RedisAdapter
