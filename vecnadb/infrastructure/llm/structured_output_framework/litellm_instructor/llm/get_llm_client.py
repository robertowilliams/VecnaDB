...
from vecnadb.infrastructure.llm import get_llm_config
from vecnadb.infrastructure.llm.structured_output_framework.litellm_instructor.llm.ollama.adapter import (
    OllamaAPIAdapter,
)
from vecnadb.infrastructure.llm.exceptions import (
...
def get_llm_client(raise_api_key_error: bool = True):
    ...
    # if not use value from vecnadb configuration
    from vecnadb.infrastructure.llm.utils import (
    ...
    if provider == LLMProvider.OPENAI:
        ...
        from vecnadb.infrastructure.llm.structured_output_framework.litellm_instructor.llm.openai.adapter import (
            OpenAIAdapter,
        )
        ...
        from vecnadb.infrastructure.llm.structured_output_framework.litellm_instructor.llm.generic_llm_api.adapter import (
            GenericAPIAdapter,
        )
        ...
        from vecnadb.infrastructure.llm.structured_output_framework.litellm_instructor.llm.anthropic.adapter import (
            AnthropicAdapter,
        )
        ...
        from vecnadb.infrastructure.llm.structured_output_framework.litellm_instructor.llm.gemini.adapter import (
            GeminiAdapter,
        )
        ...
        from vecnadb.infrastructure.llm.structured_output_framework.litellm_instructor.llm.mistral.adapter import (
            MistralAdapter,
        )
        ...
        from vecnadb.infrastructure.llm.structured_output_framework.litellm_instructor.llm.bedrock.adapter import (
            BedrockAdapter,
        )
