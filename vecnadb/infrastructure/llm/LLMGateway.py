...
class LLMGateway:
    ...
    def acreate_structured_output(
        ...
        if llm_config.structured_output_framework.upper() == "BAML":
            from vecnadb.infrastructure.llm.structured_output_framework.baml.baml_src.extraction import (
            ...
            from vecnadb.infrastructure.llm.structured_output_framework.litellm_instructor.llm.get_llm_client import (
                get_llm_client,
            )
