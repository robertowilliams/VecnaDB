from vecnadb.infrastructure.loaders.external import PyPdfLoader
from vecnadb.infrastructure.loaders.core import TextLoader, AudioLoader, ImageLoader, CsvLoader
...
try:
    from vecnadb.infrastructure.loaders.external import UnstructuredLoader
...
try:
    from vecnadb.infrastructure.loaders.external import AdvancedPdfLoader
...
try:
    from vecnadb.infrastructure.loaders.external import BeautifulSoupLoader
