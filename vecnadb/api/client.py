...
from vecnadb.exceptions import CogneeApiError
from vecnadb.shared.logging_utils import get_logger, setup_logging
from vecnadb.api.health import health_checker, HealthStatus
from vecnadb.api.v1.cloud.routers import get_checks_router
from vecnadb.api.v1.notebooks.routers import get_notebooks_router
from vecnadb.api.v1.permissions.routers import get_permissions_router
from vecnadb.api.v1.settings.routers import get_settings_router
from vecnadb.api.v1.datasets.routers import get_datasets_router
from vecnadb.api.v1.cognify.routers import get_cognify_router
from vecnadb.api.v1.search.routers import get_search_router
from vecnadb.api.v1.ontologies.routers.get_ontology_router import get_ontology_router
from vecnadb.api.v1.memify.routers import get_memify_router
from vecnadb.api.v1.add.routers import get_add_router
from vecnadb.api.v1.delete.routers import get_delete_router
from vecnadb.api.v1.responses.routers import get_responses_router
from vecnadb.api.v1.sync.routers import get_sync_router
from vecnadb.api.v1.update.routers import get_update_router
from vecnadb.api.v1.users.routers import (
    get_auth_router,
    get_register_router,
...
from vecnadb.modules.users.methods.get_authenticated_user import REQUIRE_AUTHENTICATION
...
async def lifespan(app: FastAPI):
    # from vecnadb.modules.data.deletion import prune_system, prune_data
    # await prune_data()
