...
def get_permissions_router() -> APIRouter:
    ...
    async def create_role(role_name: str, user: User = Depends(get_authenticated_user)):
        ...
        from vecnadb.modules.users.roles.methods import create_role as create_role_method
    ...
    async def add_user_to_role(
        ...
        from vecnadb.modules.users.roles.methods import add_user_to_role as add_user_to_role_method
    ...
    async def create_tenant(tenant_name: str, user: User = Depends(get_authenticated_user)):
        ...
        from vecnadb.modules.users.tenants.methods import create_tenant as create_tenant_method
    ...
    async def select_tenant(payload: SelectTenantDTO, user: User = Depends(get_authenticated_user)):
        ...
        from vecnadb.modules.users.tenants.methods import select_tenant as select_tenant_method
