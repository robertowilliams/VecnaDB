...
from vecnadb.modules.data.models import Data, DatasetData, Dataset
...
from vecnadb.api.v1.exceptions import (
...
async def delete_single_document(data_id: str, dataset_id: UUID = None, mode: str = "soft"):
    ...
    async with db_engine.get_async_session() as session:
        ...
        from vecnadb.modules.data.models.graph_relationship_ledger import GraphRelationshipLedger
