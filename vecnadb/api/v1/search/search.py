...
from vecnadb.modules.search.types import SearchResult, SearchType, CombinedSearchResult
from vecnadb.modules.users.methods import get_default_user
from vecnadb.modules.search.methods import search as search_function
from vecnadb.modules.data.methods import get_authorized_existing_datasets
from vecnadb.modules.data.exceptions import DatasetNotFoundError
from vecnadb.context_global_variables import set_session_user_context_variable
...
async def search(
    ...
    Search Prerequisites:
        ...
        - **Knowledge Graph Built**: Must have processed data via `vecnadb.cognify()`
