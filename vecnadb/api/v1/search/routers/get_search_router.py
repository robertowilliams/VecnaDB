...
from vecnadb.modules.search.types import SearchType, SearchResult, CombinedSearchResult
from vecnadb.api.DTO import InDTO, OutDTO
from vecnadb.modules.users.exceptions.exceptions import PermissionDeniedError
...
def get_search_router() -> APIRouter:
    ...
    async def search(payload: SearchPayloadDTO, user: User = Depends(get_authenticated_user)):
        ...
        from vecnadb.api.v1.search import search as cognee_search
