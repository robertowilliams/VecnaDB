...
from vecnadb.api.DTO import InDTO, OutDTO
...
from vecnadb.modules.data.methods import create_dataset, get_datasets_by_name
from vecnadb.shared.logging_utils import get_logger
from vecnadb.api.v1.exceptions import DataNotFoundError, DatasetNotFoundError
from vecnadb.modules.users.models import User
from vecnadb.modules.users.methods import get_authenticated_user
from vecnadb.modules.users.permissions.methods import (
    get_all_user_permission_datasets,
    give_permission_on_dataset,
)
from vecnadb.modules.graph.methods import get_formatted_graph_data
from vecnadb.modules.pipelines.models import PipelineRunStatus
...
def get_datasets_router() -> APIRouter:
    ...
    async def delete_dataset(dataset_id: UUID, user: User = Depends(get_authenticated_user)):
        ...
        from vecnadb.modules.data.methods import delete_dataset
    ...
    async def delete_data(
        ...
        from vecnadb.modules.data.methods import get_data, delete_data
    ...
    async def get_dataset_status(
        ...
        from vecnadb.api.v1.datasets.datasets import datasets as cognee_datasets
    ...
    async def get_raw_data(
        ...
        from vecnadb.modules.data.methods import get_data
        from vecnadb.modules.data.methods import get_dataset_data
