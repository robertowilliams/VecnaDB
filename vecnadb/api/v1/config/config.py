...
from vecnadb.infrastructure.data.chunking.config import get_chunk_config
from vecnadb.infrastructure.databases.vector import get_vectordb_config
from vecnadb.infrastructure.databases.graph.config import get_graph_config
from vecnadb.infrastructure.llm.config import (
    get_llm_config,
)
from vecnadb.infrastructure.databases.relational import get_relational_config, get_migration_config
from vecnadb.api.v1.exceptions.exceptions import InvalidConfigAttributeError
...
class config:
    ...
    def system_root_directory(system_root_directory: str):
        ...
        if vector_config.vector_db_provider == "lancedb":
            vector_config.vector_db_url = os.path.join(databases_directory_path, "vecnadb.lancedb")
