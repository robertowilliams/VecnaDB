...
from vecnadb.api.DTO import InDTO
from vecnadb.modules.pipelines.methods import get_pipeline_run
...
from vecnadb.modules.users.authentication.default.default_jwt_strategy import DefaultJWTStrategy
from vecnadb.modules.pipelines.models.PipelineRunInfo import (
    PipelineRunCompleted,
    PipelineRunInfo,
    PipelineRunErrored,
)
from vecnadb.modules.pipelines.queues.pipeline_run_info_queues import (
    get_from_queue,
    initialize_queue,
    remove_queue,
)
...
def get_cognify_router() -> APIRouter:
    ...
    async def cognify(payload: CognifyPayloadDTO, user: User = Depends(get_authenticated_user)):
        ...
        from vecnadb.api.v1.cognify import cognify as cognee_cognify
        from vecnadb.api.v1.ontologies.ontologies import OntologyService
        ...
        try:
            ...
            if payload.ontology_key:
                ...
                from vecnadb.modules.ontology.rdf_xml.RDFLibOntologyResolver import (
