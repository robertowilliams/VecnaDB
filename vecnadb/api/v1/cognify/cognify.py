...
from vecnadb.modules.ontology.ontology_env_config import get_ontology_env_config
...
from vecnadb.modules.pipelines import run_pipeline
from vecnadb.modules.pipelines.tasks.task import Task
from vecnadb.modules.chunking.TextChunker import TextChunker
from vecnadb.modules.ontology.ontology_config import Config
from vecnadb.modules.ontology.get_default_ontology_resolver import (
...
from vecnadb.tasks.graph import extract_graph_from_data
from vecnadb.tasks.storage import add_data_points
from vecnadb.tasks.summarization import summarize_text
from vecnadb.modules.pipelines.layers.pipeline_execution_mode import get_pipeline_executor
from vecnadb.tasks.temporal_graph.extract_events_and_entities import extract_events_and_timestamps
from vecnadb.tasks.temporal_graph.extract_knowledge_graph_from_events import (
...
async def cognify(
    ...
    **kwargs,
    ...
    Prerequisites:
        ...
        - **Data Added**: Must have data previously added via `vecnadb.add()`
        - **Vector Database**: Must be accessible for embeddings storage
        - **Graph Database**: Must be accessible for relationship storage

    Input Requirements:
        - **Datasets**: Must contain data previously added via `vecnadb.add()`
    ...
    Next Steps:
        ...
        ```python
        import vecnadb
        from vecnadb import SearchType
        ...
        insights = await vecnadb.search(
            "What are the main themes?",
            query_type=SearchType.GRAPH_COMPLETION
        )

        # 2. Get entity relationships and connections
        relationships = await vecnadb.search(
            "connections between concepts",
            query_type=SearchType.GRAPH_COMPLETION
        )

        # 3. Find relevant document chunks
        chunks = await vecnadb.search(
            "specific topic",
    ...
    Advanced Usage:
        ...
        run_info = await vecnadb.cognify(
