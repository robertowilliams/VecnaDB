...
from vecnadb.modules.users.permissions.methods import get_specific_user_permission_datasets
from vecnadb.modules.sync.methods import get_running_sync_operations_for_user, get_sync_operation
from vecnadb.shared.utils import send_telemetry
from vecnadb.shared.logging_utils import get_logger
from vecnadb.api.v1.sync import SyncResponse
...
def get_sync_router() -> APIRouter:
    ...
    async def sync_to_cloud(
        ...
        from vecnadb.api.v1.sync import sync as cognee_sync
