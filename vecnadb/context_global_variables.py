...
from vecnadb.infrastructure.databases.utils import get_or_create_dataset_database
from vecnadb.infrastructure.databases.utils import resolve_dataset_database_connection_info
from vecnadb.infrastructure.files.storage.config import file_storage_config
...
def multi_user_support_possible():
    ...
    from vecnadb.infrastructure.databases.dataset_database_handler import (
