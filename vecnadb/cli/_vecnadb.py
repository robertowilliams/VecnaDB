...
from vecnadb.cli import SupportsCliCommand, DEFAULT_DOCS_URL
from vecnadb.cli.config import CLI_DESCRIPTION
from vecnadb.cli import debug
import vecnadb.cli.echo as fmt
...
# Debug functionality is now in vecnadb.cli.debug module
...
def _discover_commands() -> List[Type[SupportsCliCommand]]:
    ...
    command_modules = [
        ("vecnadb.cli.commands.add_command", "AddCommand"),
        ("vecnadb.cli.commands.search_command", "SearchCommand"),
        ("vecnadb.cli.commands.cognify_command", "CognifyCommand"),
        ("vecnadb.cli.commands.delete_command", "DeleteCommand"),
        ("vecnadb.cli.commands.config_command", "ConfigCommand"),
    ]
