...
Configuration changes will affect how cognee processes and stores data.
    ...
    def _handle_get(self, args: argparse.Namespace) -> None:
        try:
            ...
            if args.key:
                # Get specific key
                try:
                    if hasattr(vecnadb.config, "get"):
                        value = vecnadb.config.get(args.key)
                ...
                try:
                    if hasattr(vecnadb.config, "get_all"):
                        config_dict = vecnadb.config.get_all()
                        if config_dict:
    ...
    def _handle_set(self, args: argparse.Namespace) -> None:
        try:
            ...
            try:
                vecnadb.config.set(args.key, value)
        ...
        try:
            ...
            if args.key in config_key_mappings:
                ...
                try:
                    ...
                    method = getattr(vecnadb.config, method_name)
    ...
    def _handle_list(self, args: argparse.Namespace) -> None:
        try:
            ...
            # This would need to be implemented in vecnadb.config
