...
from vecnadb.api.v1.cognify.cognify import get_default_tasks
from vecnadb.modules.pipelines.tasks.task import Task
from vecnadb.eval_framework.corpus_builder.task_getters.get_cascade_graph_tasks import (
    get_cascade_graph_tasks,
)
from vecnadb.eval_framework.corpus_builder.task_getters.get_default_tasks_by_indices import (
