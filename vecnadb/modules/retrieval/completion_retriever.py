...
from vecnadb.modules.retrieval.exceptions.exceptions import NoDataError
from vecnadb.infrastructure.databases.vector.exceptions import CollectionNotFoundError
