...
from vecnadb.modules.search.types import (
    SearchResult,
    CombinedSearchResult,
    SearchResultDataset,
    SearchType,
)
from vecnadb.modules.search.operations import log_query, log_result
from vecnadb.modules.users.models import User
from vecnadb.modules.data.models import Dataset
from vecnadb.modules.data.methods.get_authorized_existing_datasets import (
...
async def search(
    ...
    send_telemetry(
        "vecnadb.search EXECUTION STARTED",
        user.id,
    ...
    send_telemetry(
        "vecnadb.search EXECUTION COMPLETED",
        user.id,
        additional_properties={
            "cognee_version": cognee_version,
            "tenant_id": str(user.tenant_id) if user.tenant_id else "Single User Tenant",
