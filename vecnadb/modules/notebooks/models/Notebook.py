...
from vecnadb.infrastructure.databases.relational import Base
from vecnadb.shared.cache import (
...
class Notebook(Base):
    ...
    async def from_ipynb_zip_url(
        ...
        from vecnadb.shared.cache import cache_file_exists, read_cache_file
    ...
    async def _update_file_paths_in_cells(notebook: "Notebook", cache_dir: str) -> None:
        ...
        """
        import re
        from vecnadb.shared.cache import list_cache_files, cache_file_exists
