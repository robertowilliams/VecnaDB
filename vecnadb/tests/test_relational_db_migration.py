...
from vecnadb.infrastructure.databases.relational import (
    get_migration_relational_engine,
    create_db_and_tables as create_relational_db_and_tables,
)
from vecnadb.infrastructure.databases.vector.pgvector import (
    create_db_and_tables as create_pgvector_db_and_tables,
)
from vecnadb.tasks.ingestion import migrate_relational_database
...
async def test_migration_sqlite():
    ...
    vecnadb.config.set_migration_db_config(
        {
