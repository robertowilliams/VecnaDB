...
async def test_deduplication():
    ...
    await vecnadb.add([explanation_file_path], dataset_name, incremental_loading=False)
    await vecnadb.add([explanation_file_path2], dataset_name2, incremental_loading=False)
    ...
    await vecnadb.add([text], dataset_name2)
    ...
    await vecnadb.add([explanation_file_path], dataset_name)
    await vecnadb.add([explanation_file_path2], dataset_name2)
...
async def test_deduplication_postgres():
    ...
    vecnadb.config.set_relational_db_config(
        {
            "db_name": "cognee_db",
            "db_host": "127.0.0.1",
            "db_port": "5432",
