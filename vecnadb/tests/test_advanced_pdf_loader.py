...
from vecnadb.infrastructure.loaders.external.advanced_pdf_loader import AdvancedPdfLoader

advanced_pdf_loader_module = sys.modules.get(
    "vecnadb.infrastructure.loaders.external.advanced_pdf_loader"
)
...
@pytest.mark.asyncio
@patch("vecnadb.infrastructure.loaders.external.advanced_pdf_loader.open", new_callable=mock_open)
@patch(
    "vecnadb.infrastructure.loaders.external.advanced_pdf_loader.get_file_metadata",
    new_callable=AsyncMock,
)
@patch("vecnadb.infrastructure.loaders.external.advanced_pdf_loader.get_storage_config")
@patch("vecnadb.infrastructure.loaders.external.advanced_pdf_loader.get_file_storage")
@patch("vecnadb.infrastructure.loaders.external.advanced_pdf_loader.PyPdfLoader")
@patch("vecnadb.infrastructure.loaders.external.advanced_pdf_loader.partition_pdf")
...
@patch("vecnadb.infrastructure.loaders.external.advanced_pdf_loader.PyPdfLoader")
@patch(
    "vecnadb.infrastructure.loaders.external.advanced_pdf_loader.partition_pdf",
