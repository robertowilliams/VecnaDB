...
class TestCliIntegration:
    ...
    def test_cli_help(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "vecnadb.cli._cognee", "--help"],
            capture_output=True,
            text=True,
    ...
    def test_cli_version(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "vecnadb.cli._cognee", "--version"],
            capture_output=True,
            text=True,
            cwd=Path(__file__).parent.parent.parent,  # Go to project root
        )
    ...
    def test_command_help(self):
        ...
        for command in commands:
            result = subprocess.run(
                [sys.executable, "-m", "vecnadb.cli._cognee", command, "--help"],
                capture_output=True,
                text=True,
                cwd=Path(__file__).parent.parent.parent,  # Go to project root
            )
    ...
    def test_invalid_command(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "vecnadb.cli._cognee", "invalid_command"],
            capture_output=True,
            text=True,
            cwd=Path(__file__).parent.parent.parent,  # Go to project root
        )
    ...
    def test_add_command_integration(self, mock_add):
        ...
        try:
            result = subprocess.run(
                [sys.executable, "-m", "vecnadb.cli._cognee", "add", temp_file],
                capture_output=True,
                text=True,
                cwd=Path(__file__).parent.parent.parent,  # Go to project root
            )
    ...
    def test_config_subcommands(self):
        ...
        for subcommand in subcommands:
            result = subprocess.run(
                [sys.executable, "-m", "vecnadb.cli._cognee", "config", subcommand, "--help"],
                capture_output=True,
                text=True,
                cwd=Path(__file__).parent.parent.parent,  # Go to project root
            )
    ...
    def test_search_command_missing_query(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "vecnadb.cli._cognee", "search"],
            capture_output=True,
            text=True,
            cwd=Path(__file__).parent.parent.parent,  # Go to project root
        )
    ...
    def test_delete_command_no_target(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "vecnadb.cli._cognee", "delete"],
            capture_output=True,
            text=True,
            cwd=Path(__file__).parent.parent.parent,  # Go to project root
        )
...
class TestCliArgumentParsing:
    ...
    def test_config_set_command(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "vecnadb.cli._cognee", "config", "set", "test_key", "test_value"],
            capture_output=True,
            text=True,
            cwd=Path(__file__).parent.parent.parent,  # Go to project root
        )
...
class TestCliErrorHandling:
    ...
    def test_debug_mode_flag(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "vecnadb.cli._cognee", "--debug", "search", "test query"],
            capture_output=True,
            text=True,
            cwd=Path(__file__).parent.parent.parent,  # Go to project root
        )
    ...
    def test_invalid_chunker(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "vecnadb.cli._cognee", "cognify", "--chunker", "InvalidChunker"],
            capture_output=True,
            text=True,
            cwd=Path(__file__).parent.parent.parent,  # Go to project root
        )
