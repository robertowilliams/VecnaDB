...
from vecnadb.cli._cognee import main, _discover_commands, _create_parser
...
class TestCliMain:
    ...
    @patch("vecnadb.cli._cognee._create_parser")
    ...
    @patch("vecnadb.cli._cognee._create_parser")
    @patch("vecnadb.cli.debug.is_debug_enabled")
...
class TestDebugAction:
    ...
    @patch("vecnadb.cli.debug.enable_debug")
    @patch("vecnadb.cli.echo.note")
    def test_debug_action_call(self, mock_note, mock_enable_debug):
        """Test that DebugAction enables debug mode"""
        from vecnadb.cli._cognee import DebugAction
