...
async def main():
    ...
    await vecnadb.add([ai_text_file_path], dataset_name)
    ...
    cognify_run_info = await vecnadb.cognify([dataset_name])
    ...
    # Test visualization
    from vecnadb import visualize_graph
