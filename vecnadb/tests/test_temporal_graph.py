...
from vecnadb.shared.logging_utils import setup_logging, INFO
from vecnadb.tasks.temporal_graph.models import Timestamp
from vecnadb.api.v1.search import SearchType
...
async def main():
    ...
    await vecnadb.add([biography_1, biography_2])

    await vecnadb.cognify(temporal_cognify=True)
