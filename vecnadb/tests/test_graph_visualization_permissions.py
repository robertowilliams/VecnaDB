...
import vecnadb
from vecnadb.api.client import app
from vecnadb.modules.users.methods import create_user, get_default_user
...
async def setup_environment():
    ...
    vecnadb.config.data_root_directory(str(base_dir / ".data_storage/test_graph_viz"))
    vecnadb.config.system_root_directory(str(base_dir / ".cognee_system/test_graph_viz"))
    ...
    await vecnadb.add([explanation_file_path], dataset_name="NLP")
