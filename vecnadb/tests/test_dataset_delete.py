...
import vecnadb
from vecnadb.shared.logging_utils import setup_logging, ERROR
from vecnadb.modules.data.methods.delete_dataset import delete_dataset
from vecnadb.modules.data.methods.get_dataset import get_dataset
...
async def main():
    ...
    await vecnadb.add(text, "nlp_dataset")
    await vecnadb.add("Quantum computing is the study of quantum computers.", "quantum_dataset")

    # Use LLMs and cognee to create knowledge graph
    ret_val = await vecnadb.cognify()
