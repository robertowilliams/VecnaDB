...
async def main():
    ...
    await vecnadb.add(data=text_data, dataset_name=dataset_name)
    ...
    try:
        ...
        await vecnadb.cognify(datasets=[dataset_name], config=config)
        ...
        search_results_phase2 = await vecnadb.search(
...
if __name__ == "__main__":
    import asyncio
    from vecnadb.shared.logging_utils import setup_logging
