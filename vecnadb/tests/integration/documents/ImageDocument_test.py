...
from vecnadb.modules.data.processing.document_types.ImageDocument import ImageDocument
...
chunk_by_sentence_module = sys.modules.get("vecnadb.tasks.chunks.chunk_by_sentence")
