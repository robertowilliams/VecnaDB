...
import pytest
import vecnadb
from vecnadb.infrastructure.files.utils.get_data_file_path import get_data_file_path
from vecnadb.infrastructure.loaders.LoaderEngine import LoaderEngine
from vecnadb.infrastructure.loaders.external.beautiful_soup_loader import BeautifulSoupLoader
...
async def test_add_url():
    ...
    await vecnadb.add("http://example.com/")
