...
gau_mod = importlib.import_module("vecnadb.modules.users.methods.get_authenticated_user")
...
class TestConditionalAuthenticationEndpoints:
    ...
    @patch(
        "vecnadb.api.client.REQUIRE_AUTHENTICATION",
        False,
    )
...
class TestConditionalAuthenticationBehavior:
    ...
    gsm_mod = importlib.import_module("vecnadb.modules.settings.get_settings")
...
class TestConditionalAuthenticationErrorHandling:
    ...
    def test_current_environment_configuration(self, client):
        ...
        from vecnadb.modules.users.methods.get_authenticated_user import (
