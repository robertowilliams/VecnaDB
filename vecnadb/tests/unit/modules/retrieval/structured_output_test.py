...
from vecnadb.low_level import setup, DataPoint
from vecnadb.tasks.storage import add_data_points
from vecnadb.modules.chunking.models import DocumentChunk
...
from vecnadb.modules.retrieval.entity_extractors.DummyEntityExtractor import DummyEntityExtractor
from vecnadb.modules.retrieval.context_providers.DummyContextProvider import DummyContextProvider
...
from vecnadb.modules.retrieval.EntityCompletionRetriever import EntityCompletionRetriever
...
class TestStructuredOutputCompletion:
    ...
    async def test_get_structured_completion(self):
        ...
        vecnadb.config.system_root_directory(system_directory_path)
