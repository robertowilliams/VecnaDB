...
async def test_code_description_to_code_part_no_results():
    ...
    with (
        patch(
            "vecnadb.modules.retrieval.utils.description_to_codepart_search.get_vector_engine",
            return_value=mock_vector_engine,
        ),
        patch(
            "vecnadb.modules.retrieval.utils.description_to_codepart_search.get_graph_engine",
            return_value=AsyncMock(),
        ),
        patch(
            "vecnadb.modules.retrieval.utils.description_to_codepart_search.CogneeGraph",
            return_value=AsyncMock(),
        ),
    ):
        from vecnadb.modules.retrieval.utils.description_to_codepart_search import (
