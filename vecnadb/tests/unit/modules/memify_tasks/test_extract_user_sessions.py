...
from vecnadb.tasks.memify.extract_user_sessions import extract_user_sessions
from vecnadb.exceptions import CogneeSystemError
from vecnadb.modules.users.models import User

# Get the actual module object (not the function) for patching
extract_user_sessions_module = sys.modules["vecnadb.tasks.memify.extract_user_sessions"]
