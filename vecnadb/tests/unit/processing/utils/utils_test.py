...
from vecnadb.root_dir import ensure_absolute_path
from vecnadb.infrastructure.files.utils.get_file_content_hash import get_file_content_hash
from vecnadb.shared.utils import get_anonymous_id
